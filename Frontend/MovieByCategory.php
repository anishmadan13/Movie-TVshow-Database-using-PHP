...
<div class="container_wrapper">
    ...
    <div class="col2">
		...
		$line = 0;
		$page = 'Category.php';
		$dataperpage = mysqli_query($connect,"SELECT * FROM tblmovie WHERE id = '$id'");
        ...
        $getMovie = mysqli_query($connect,"SELECT * FROM tblmovie  WHERE id = '$id' ORDER BY id LIMIT $eu,$limit");
