...
<div class="container_wrapper">
    ...
    <div class="col2">
        	...
        	<form name="search" id="search" method="post" action="SearchShow.php" onsubmit="return validate()">
            	<table>
                	<tr>
                        ...
                        <td>
                        	<input type="text" id="search" name="search" placeholder="Enter TV Show Name" size="39"/>
                        </td>
                        <td>
		...
		$line = 0;
		$page = 'shows.php';
		$dataperpage = mysqli_query($connect,"SELECT * FROM tblshows");
        ...
        $getShow = mysqli_query($connect,"SELECT * FROM tblshows ORDER BY id LIMIT $eu,$limit");
